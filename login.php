                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Konnichiwa !</h1>
                                    </div>
                                    <form class="user" action="" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" type="submit" name="submit">Masuk Yuk :)</button>
                                    </form>
                                    <hr>
                                    <p><b>Username : </b>shun</p>
                                    <p><b>Password : </b>shunk</p>
                                </div>
                            </div>
                        </div>
                    </div>
